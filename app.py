...
if not api_key_input:
    ...
    try:
        if (
            ...
            system_instruction = (
                "당신은 몰입감 있는 정통 판타지 텍스트 RPG의 게임 마스터(GM)입니다. 휴먼.오크.엘프.드워프가 각자 자신들의 영토확장을 위해 싸우는 것이 스토리의 큰 흐름 입니다. 주인공은 랜덤으로 각종족 의 고아원을 떠나는것으로 시작 합니다"
                "레벨업은 적을 죽일일때 얻는 경험치가 충족되면 합니다."
